...
public class Common {
	 ...
	 * @return String
	 */
	public static String fromDateyyyyMM(){
	 ...
	 * @return
	 */
	public static String yesterdayModthFirstday(){
		Calendar calendar = Calendar.getInstance();
		calendar.add(Calendar.DATE,   -1);
	...
	public static void initSession(HttpSession session){
		...
		while(em.hasMoreElements()){
			...
			/*if(sessionName.equals(Constants.SESSION_ADMIN) ||
					sessionName.equals(Constants.SESSION_COMPANY_USER) ||
					sessionName.equals(Constants.SESSION_COMPANY_BASE)||
					sessionName.equals(Constants.SESSION_PRODUCT_BACK)){
				session.removeAttribute(sessionName);
			}*/
		}
	}
