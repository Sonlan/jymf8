...
public class ProductController{
	...
	public String add(Model model,HttpSession session) {
		...
		model.addAttribute("hnums", areaService.findHnum());
    	JsonMapper jsonm = new JsonMapper();
    	model.addAttribute("hnumsJson", jsonm.toJson(areaService.findHnum()));
	...
	public String add(Product product, HttpSession session) {
		...
		productService.add(product,companyUser.getCompanyName() ,webUrl+Constants.CACHE_FOLDER,companyUser.getWorkMode());
