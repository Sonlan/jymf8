...
public interface CompanyMapper{
	 ...
	 * 根据监管部门查询旗下全部企业信息 
	 */
	List<Company> findCompanyByMonitor(Map<Object, Object> map);
     ...
     * 创建标签申请单
     */
	void createPreLabel(Map<String, Object> map);
	
	/**
	 * 创建进口计划单
	 */ 
	void createImportPlan(Map<String, Object> map);
	
	/**
	 *	创建进口计划单产品表 
	 */ 
	void createImportPlanProduct(Map<String, Object> map);
	
	int getNumByLce(String lceNum);
	
	int getNumByCpName(String cpName);
