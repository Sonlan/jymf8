...
<div class="centre">
<form:form id="login" action="${ctx}/monitor/logins" method="post">
    <div class="centre_one_jinchukou">
    	<img alt="" src="${ctx}/static/images/2_jinchukou.png" style="margin-left: -120px;">
    </div>
