...
<body>
<form:form id="fenye" name="fenye" modelAttribute="label" action="${ctx}/admin/dialog/selectPrelabeledProduct/${companyId}" method="post">
     <div id="content_top">
        <table class="jymf_table">
            <tr class="table_1_tr">
                <td>货物名称&nbsp;<input name="productName" type="text"/></td>
    ...
    <table id="table_1" class="jymf_table table_border">
        <tr id="table_1_titlebar">
            <td class="jymf_td row_3" rowspan="1" colspan="1">货物名称</td>
            <td class="jymf_td row_3" rowspan="1" colspan="1">总凭证数量</td>
            <td class="jymf_td row_1" rowspan="1" colspan="1">货物代码</td>
        ...
        <tr class="jymf_tr table_1_tr">
            <td class="jymf_td row_3" >
           		<div class="td_name_1">
                    <a title="${labelIndex.productName}">${labelIndex.productName}</a>
                </div>
            </td>
            <td>${labelIndex.finalCount}</td>
            <td>${labelIndex.productId}</td>
            <td>
                <a href="javascript:setProductview('${labelIndex.productId}','${labelIndex.productName}');">选择</a>
            </td>
        </tr>
        </c:forEach>
