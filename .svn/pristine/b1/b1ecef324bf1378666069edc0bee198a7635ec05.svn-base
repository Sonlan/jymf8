...
<div class="row">
    ...
    <div class="box-content">
		...
		<form:form id="addform" modelAttribute="plan" action="${ctx}/company/importPlan/add" method="post">
	   		 <table class="table">
    		...
    		<div class="col-md-12 form-group" style="vertical-align: bottom;" >
				...
				<div class="col-md-4"><input type="text" class="form-control" name="id"/></div>
				<div class="col-md-2" align="right"><label style="padding:5px;">货物名称</label></div>
				<div class="col-md-4"><input type="text" id="productName" style="cursor: pointer;" class="form-control" name="productName" readonly="readonly" onclick="showdiv();" value="点击选择货物"/></div>
			</div>
    		<div class="col-md-12 form-group" style="vertical-align: bottom;" >
				<div class="col-md-2" align="right"><label style="padding:5px;">产地</label></div>
				<div class="col-md-4"><input type="text" class="form-control" name="origin" /></div>
				<div class="col-md-2" align="right"><label style="padding:5px;">原料信息</label></div>
				<div class="col-md-4"><input type="text" class="form-control" name="material"/></div>
			</div>
    		<div class="col-md-12 form-group" style="vertical-align: bottom;" >
				<div class="col-md-2" align="right"><label style="padding:5px;">生产信息</label></div>
				<div class="col-md-4"><input type="text" class="form-control" name="produceInfo" /></div>
				<div class="col-md-2" align="right"><label style="padding:5px;">生产日期</label></div>
				<div class="col-md-4"><input type="text" class="form-control Wdate" name="produceDate"
    		...
    		<div class="col-md-12 form-group" style="vertical-align: bottom;" >
				...
				<div class="col-md-4"><input type="text" class="form-control"  name="produceBatchNum"/></div>
				<div class="col-md-2" align="right"><label style="padding:5px;">出厂日期</label></div>
				<div class="col-md-4"><input type="text" class="form-control Wdate" name="outFactoryDate"
						   onclick="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd HH:mm:ss'})"
						   style="width:100%;height:34px;margin:0;border-color:#CCCCCC" />
				</div>
			</div>
    		...
    		<div class="col-md-12 form-group" style="vertical-align: bottom;" >
				...
				<div class="col-md-4"><input type="text" class="form-control" name="hnum" /></div>
				<div class="col-md-2" align="right"><label style="padding:5px;">签发单位</label></div>
				<div class="col-md-4"><input type="text" class="form-control" name="hunit"/></div>
			</div>
    		<div class="col-md-12 form-group" style="vertical-align: bottom;" >
				<div class="col-md-2" align="right"><label style="padding:5px;">报检单号</label></div>
				<div class="col-md-4"><input type="text" class="form-control" name="baojiandan" /></div>
			...
			<div class="col-md-12 form-group" style="vertical-align: bottom;" >
				...
				<div class="col-md-4"><input type="text" class="form-control" name="baoguandan" /></div>
