    ...
    <div style="text-align: center;">
        <table style="margin:50px 0 50px 100px;">
        	...
        	<tr >
        		...
        		<td>
        			<input style="height: 20px;width:350px;font-family: Arial;font-size: 13px;" type="text" id="name" name="name"/>
        	...
        	<tr style="height:70px;">
        		...
        		<td>
        			<textarea style="height: 60px;width:350px;font-family: Arial;font-size: 13px;"  name="value" id="value"></textarea>
        			<span class="must">*</span>
        		</td>
        	</tr>
