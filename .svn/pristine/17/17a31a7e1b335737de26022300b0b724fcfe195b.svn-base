...
function showPhone(id){
	 ...
	 var phoneHtml = "<table class='phoneTable'>"+
	 				 ...
	 				 "</span><span style='font-size: 12px;padding-left:30%'>"+title+"</span></td></tr>";
	
	 var nameDiv =  document.getElementById("win").contentWindow.$("div[name='"+id+".name']");
	 var valueDiv = document.getElementById("win").contentWindow.$("div[name='"+id+".value']");
	 
	 var trs = document.getElementById("win").contentWindow.$("#"+id+" tr");
