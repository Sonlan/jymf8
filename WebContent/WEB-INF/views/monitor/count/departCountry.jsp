...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2 id="title_h2">启运国家统计</h2>
    </div>
    <div class="box-content">
   		<div id="tiaojian" class="alert alert-info" style="padding:5px;margin-bottom:5px;">
			<form:form id="fenye" class="form-inline" action="${ctx}/monitor/count/queryDepartCountry" method="post">
				<div class="form-group">
			      	<label>启运国家&nbsp;&nbsp;</label>
			        <select class="chzn-select form-inline input-sm" name="departCountry">
			        	<option value="">全部查询</option>
			        	<c:forEach items="${worldAreas}" var="list">
			        		<option value="${list.areaName}" <c:if test="${count.departCountry==list.areaName}">selected="selected"</c:if> >${list.areaName}</option>
			        	</c:forEach>
			        </select>&nbsp;&nbsp;
			  	</div>    
			   	<div class="form-group">
