...
<body>
<form:form id="fenye" name="fenye" action="${ctx}/monitor/company/document/query" method="post">
    <div id="content_top">
    ...
    <table id="table_1" class="jymf_table table_border">
        ...
        <tr class="jymf_tr table_1_tr">
            ...
            <td align="center">
                <div class="small_btn">
                    <a class="linke" href="${ctx}/monitor/company/document/view/${documnet.id}" id="editLink-${documnet.id}">详细</a>
                </div>
            </td>
        </tr>
        </c:forEach>
