...
function setProductview(productId,name){
	//给父窗体的动态文本框赋值
    parent.document.getElementById("win").contentWindow.setProduct(productId,name);
    parent.hidediv();
}
//关闭弹出层
function hidebtn(){
...
<body>
<form:form id="fenye" name="fenye" modelAttribute="product" action="${ctx}/admin/dialog/selectProduct/${companyId}" method="post">
     <div id="content_top">
        <table class="jymf_table">
            <tr class="table_1_tr">
                <td>货物名称&nbsp;<input name="name" type="text"/></td>
                <td>HS编码&nbsp;<input name="hsnum" type="text"/></td>
    ...
    <table id="table_1" class="jymf_table table_border">
        <tr id="table_1_titlebar">
            <td class="jymf_td row_3" rowspan="1" colspan="1">产品名称</td>
            <td class="jymf_td row_1" rowspan="1" colspan="1">HS编码</td>
            <td class="jymf_td row_1" rowspan="1" colspan="1">产品代码</td>
