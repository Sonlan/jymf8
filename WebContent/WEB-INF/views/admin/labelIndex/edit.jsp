			    ...
			    <div class="box-content">
					...
					<input name="id" type="hidden" value="${labelIndex.id}"/>
						...
						<div class="col-md-12 form-group " style="vertical-align: bottom;" >
							...
							<div class="col-md-4"><input type="text" style="width:80%" maxlength="16" class="form-control" name="startTid" value="${labelIndex.startTid}"/></div>
						</div>
						<div class="col-md-12 form-group " style="vertical-align: bottom;" >
							<div class="col-md-2" align="right"><label style="padding:5px;">结&nbsp;束&nbsp;标&nbsp;签</label><span style="color:red" >*</span></div>
							<div class="col-md-4"><input type="text" style="width:80%" maxlength="16" class="form-control" name="endTid" value="${labelIndex.endTid}"/></div>
						</div>
			    		<div class="col-md-12 form-group " style="vertical-align: bottom;" >
							<div class="col-md-2" align="right"><label style="padding:5px;">所&nbsp;属&nbsp;企&nbsp;业</label><span style="color:red" >*</span></div>
							<div class="col-md-4"><input style="width:80%" id="companyName" class="form-control" name="name" type="text" value="${labelIndex.name}" readonly/></div>
							<div class="col-md-2">
						...
						<div class="col-md-12 form-group " style="vertical-align: bottom;" >
							<div class="col-md-2" align="right"><label style="padding:5px;">标&nbsp;签&nbsp;状&nbsp;态</label></div>
							<div class="col-md-4"><form:select path="status" style="width:80%" class="form-control" items="${statusMap}" value="${labelIndex.status}"/></div>
						</div>
