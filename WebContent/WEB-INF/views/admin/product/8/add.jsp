    ...
    <div class="add_top">
        ...
        <table border="0" cellpadding="0" cellspacing="0" >
            ...
            <tr>
                <td>HS&nbsp;编&nbsp;码&nbsp;</td>
                <td>
                    <input type="text" class="text" name="hsnum" maxlength="100"/>
                </td>
            </tr>
            ...
            <tr>
                <td>产&nbsp;品&nbsp;描&nbsp;述&nbsp;</td>
                <td colspan="3"><textarea class="product_textare"  maxlength="100" name="description"></textarea></td>
            </tr>
            <tr >
                <td>查询结果描述</td>
            ...
            <tr >
                <td></td>
                <td colspan="3"><textarea class="product_textare" maxlength="80" name="queryDes" ></textarea></td>
            </tr>
            
            <tr id="tree_tr" >
                <td>产&nbsp;品&nbsp;类&nbsp;型&nbsp;</td>
                <td colspan="3" align="left">
                	<input id="type" type="text" readonly value="" class="text"/>
            ...
            <tr>
               <td class="jymf_td row_3" rowspan="1" colspan="1">
                   <span class="file-box">
                       ...
                       <input id="imgFile3" name="summFiles" type="button" class="file" onclick="changePicUrl(3)"/>
                       <input name="del" type="button" class="del" value="" onclick="delPic(3)"/>
                   	   <input id="imgFile3Name" name="productImgs[3].fileName" type="hidden"/>
                   </span>
                </td>
            </tr>
            <tr>
	            <td>
	                <img style="margin-top:25px;" id="img3" 
	                     name="imgs" 
