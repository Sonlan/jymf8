...
$(document).ready(function() {
    $("#biaoshishenqing").addClass("active");
...
<table border="0px" cellpadding="0" cellspacing="0">
    <tr>
        <td>起&nbsp;始&nbsp;标&nbsp;签
            <input class="text" name="startTid" type="text" value="${labelIndex.startTid}" maxlength="16" />
            <span class="must">*</span>
        </td>
    </tr>
    <tr>
        <td>结&nbsp;束&nbsp;标&nbsp;签
            <input class="text" name="endTid" type="text" value="${labelIndex.endTid}" maxlength="16" />
            <span class="must">*</span>
        </td>
    </tr>
    <tr>
