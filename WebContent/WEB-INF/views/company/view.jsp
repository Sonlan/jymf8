    ...
    <div class="box-content">
		<table class="table">
			<div class="col-md-12 form-group " style="vertical-align: bottom;" >
				<div class="col-md-2"><label style="padding:5px;">企业名称</label></div>
				<div class="col-md-4"><input type="text" class="form-control" readonly="readonly" name="name" value="${company.name}"/></div>
				<div class="col-md-2"><label style="padding:5px;">组织机构代码</label></div>
				<div class="col-md-4"><input type="text" class="form-control" readonly="readonly" name="licenseNum" value="${company.licenseNum}"/></div>			</div>
			<div class="col-md-12 form-group " style="vertical-align: bottom;" >
				<div class="col-md-2"><label style="padding:5px;">企业主页</label></div>
				<div class="col-md-4"><input type="text" class="form-control" readonly="readonly" name="url" value="${company.url}"/></div>
			</div>
			<div class="col-md-12 form-group " style="vertical-align: bottom;" >
				<div class="col-md-2"><label style="padding:5px;">企业描述</label></div>
				<div  class="col-md-10"><textarea class="textare" style="width:100%;border:1px solid #CCCCCC" readonly="readonly" rows="5" class="form-control" name="depict.depicts">${company.depict.depicts}</textarea></div>
			</div>
			<div class="col-md-12 form-group " style="vertical-align: bottom;" >
				<c:if test="${company.tel ne null && company.tel ne ''}">
					<div class="col-md-2"><label style="padding:5px;">举报电话</label></div>
					<div class="col-md-4"><input type="text" class="form-control" readonly="readonly" name="tel" value="${company.tel}"/></div>
	        	</c:if>  
			</div>
	        <div class="col-md-12 form-group " style="vertical-align: bottom;" >
				<div class="col-md-2"><label style="padding:5px;">企业图片</label></div>
