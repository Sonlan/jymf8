...
<form:form id="viewform" modelAttribute="product" >
    <div class="add_top">
        <div class="head_describe">货物信息</div>      
	    <table id="table_2" class="jymf_table2 table_border" width="300px">
	        <tr class="table_1_tr">
	            <td width="60px">货物名称</td><td>${product.name}</td>
	            <td width="60px">生产地址</td><td>${product.origin}</td>
	        </tr>
	        
	        <tr class="table_1_tr">
	            <td>货物主页</td><td>${product.url}</td>
	            <td>生产厂商</td><td>${product.producer}</td>
	        </tr>
	
	        <tr class="jymf_tr table_1_tr">
	            <td>货物描述</td><td colspan="3">${product.description}</td>
	        </tr>
	        <tr class="jymf_tr table_1_tr">
    ...
    <c:if test="${product.productImgs[0].fileName ne '' }">
	    <div class="add_center">
	        <div class="head_describe">货物概述图片</div>
	        <table>
	            <tr>
		            <td>
    ...
    <c:if test="${product.isInfoImg}">
	    <div class="add_center">
	        <div class="head_describe">货物描述图片</div>
	        <table>
	            <tr>
