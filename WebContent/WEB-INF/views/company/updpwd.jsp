...
$(document).ready(function(){
    ...
    $("#pwdform").validate({
        rules: {
            oldPwd: {
                required:true,
                remote:"${ctx}/company/checkOldPwd"
            },
            newPwd:{
            	required:true
            },
...
<div class="row">
    ...
    <div class="box-content">
		...
		<form:form id="pwdform" name="pwdform" action="${ctx}/company/updatePwd" method="post" >
		 <table class="table">
			...
			<div class="col-md-10 form-group " style="vertical-align: bottom;" >
				<div class="col-md-3"  align="right"><label style="padding:5px;">当前密码</label></div>
				<div class="col-md-7">
					<input class="form-control" type="password" name="oldPwd" id="oldPwd"/>
				</div>
			</div>
			<div class="col-md-10 form-group " style="vertical-align: bottom;" >
				<div class="col-md-3"  align="right"><label style="padding:5px;">新密码</label></div>
				<div class="col-md-7">
			...
			<div class="col-md-10 form-group " style="vertical-align: bottom;" >
				<div class="col-md-3"  align="right"><label style="padding:5px;">确认新密码</label></div>
				<div class="col-md-7">
